    ...
    form.submit.addEventListener("click", () => {
        ...
        switch(checkResult) {
            case 1:
                ...
                const requestData = `username=${usr}&userID=${usrID}&title=${form.title.value}&author=${form.author.value}&genre=${form.genre}&pages=${form.pages.value}&review=${form.review.value}`;
